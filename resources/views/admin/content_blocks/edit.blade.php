...
@section('title', 'Editar Bloque de Contenido')
        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h4 class="mb-0"><i class="bi bi-pencil"></i> Editar Bloque de Contenido</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('content-blocks.update', $contentBlock) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="label" 
                                   name="label" 
                                   value="{{ old('label', $contentBlock->label) }}"
                                   required>
                            @error('label')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                    ...
                                    name="type" 
                                    required>
                                <option value="text" {{ old('type', $contentBlock->type) == 'text' ? 'selected' : '' }}>Texto corto</option>
                                <option value="textarea" {{ old('type', $contentBlock->type) == 'textarea' ? 'selected' : '' }}>Texto largo</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      name="content" 
                                      rows="6"
                                      required>{{ old('content', $contentBlock->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Última actualización:</strong> {{ $contentBlock->updated_at->format('d/m/Y H:i') }}
                        </div>
